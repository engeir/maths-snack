...
import pygame as pg
import config as cf
from circles import Circle, Wheel
...
class Sim:
    ...
    def write(self):
        ...
        self.text_draw_own = Text(f'Draw your own', cf.SCREEN_WIDTH / 2,
                                  cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .1)
        self.text_choose = Text(f'Version:', cf.SCREEN_WIDTH / 2 - cf.SCREEN_WIDTH * .4,
                                cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .25, loc='l')
        self.text_choose1 = Text(f'1', cf.SCREEN_WIDTH / 2 - cf.SCREEN_WIDTH * .2,
                                 cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .25, loc='l')
        self.text_choose2 = Text(f'2', cf.SCREEN_WIDTH / 2 - cf.SCREEN_WIDTH * .1,
                                 cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .25, loc='l')
        self.text_choose3 = Text(f'3', cf.SCREEN_WIDTH / 2 - cf.SCREEN_WIDTH * .0,
                                 cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .25, loc='l')
        self.text_choose4 = Text(f'4', cf.SCREEN_WIDTH / 2 + cf.SCREEN_WIDTH * .1,
                                 cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .25, loc='l')
        self.text_choose5 = Text(f'5', cf.SCREEN_WIDTH / 2 + cf.SCREEN_WIDTH * .2,
                                 cf.SCREEN_HEIGHT / 2 - cf.SCREEN_HEIGHT * .25, loc='l')
        self.text_choose_n = [self.text_draw_own,
                              self.text_choose1,
                              self.text_choose2,
                              self.text_choose3,
                              self.text_choose4,
    ...
    def game_loop(self):
        ...
        while 1:
            ...
            if self.wait:
                ...
                self.screen.fill(cf.PURPLE, (0, 0, int(cf.SCREEN_WIDTH / 2), cf.SCREEN_HEIGHT))
                self.circle_sim()
            pg.display.update()
