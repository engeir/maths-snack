...
class DoublePendulum:
    ...
    def angles(self):
        ...
        self.num4 = self.a2_v**2 * self.r2 + self.a1_v**2 * \
            self.r1 * np.cos(self.a1 - self.a2)
        self.den = self.r1 * (2 * self.m1 + self.m2 -
                              self.m2 * np.cos(2 * self.a1 - 2 * self.a2))
        ...
        self.numm4 = self.a2_v**2 * self.r2 * \
            self.m2 * np.cos(self.a1 - self.a2)
        self.denn = self.r2 * (2 * self.m1 + self.m2 -
                               self.m2 * np.cos(2 * self.a1 - 2 * self.a2))
        self.a2_a = (self.numm1 * (self.numm2 +
                                   self.numm3 + self.numm4)) / self.denn
