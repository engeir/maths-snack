...
from maths_snack.programs.pi_count.blocks import Block
...
class TheGame:
    ...
    @staticmethod
    def text_objects(msg: str, font, color: tuple):
        u"""Kopiert fra https://pythonprogramming.net/displaying-text-pygame-screen/.

        Endret for å passe bedre til koden ellers. Bestem størrelsen til boksen
        som trengs for å vise teksten ved å returnere et rektangel som
        omkranser teksten. Returnerer teksten som 'text_surface' og den
        omkransende boksen.

        Args:
            msg: Teksten man ønsker å vise på skjermen.
            font: Fonttype og tekststørrelse (pygame.font.Font).
            color: Color of the text

        Returns:
            A text_surface and the rectangle around
        """
        text_surface = font.render(msg, True, color)
        return text_surface, text_surface.get_rect()

    def message_display(
        self, msg: str, color: tuple, posx: int, posy: int, size: int, screen
    ):
        u"""Kopiert fra https://pythonprogramming.net/displaying-text-pygame-screen/.

        Endret for å passe bedre til koden ellers. Bestem først fonttype og
        tekststørrelse før man får teksen og den omkransende boksen fra
        'text_objects'-metoden. Boksens senter bestemmes av 'posx' og 'posy',
        og tekst-objektet blir blittet til skjermen.

        Args:
            msg: Teksten man ønsker å vise på skjermen.
            color: Fargen til teksten.
            posx: Horisontal posisjon til teksten.
            posy: Vertikal posisjon til teksten.
            size: Tekststørrelse.
    ...
    def game_loop(self):
        ...
        while 1:
            ...
            pg.draw.lines(
                self.screen, WHITE, False, [(150, 0), (150, 700), (900, 700)], 3
            )
            ...
            self.message_display(
                "# " + str(self.count), WHITE, (600), (200), 70, self.screen
            )
            pg.display.update()
            self.clock.tick(FPS)
            self.events()
